...
const preguntas = [
  ...
  { id: "c22", seccion: "Sección 3 - Escala de valoración", descripcion: "Bloque 3: Suficiencia del material.", titulo: "Con los materiales que dio el docente me alcanzaba para resolver lo que tenía que hacer.", tipo: "escala", opciones: escalaValoracion },
  { id: "c23", seccion: "Sección 3 - Escala de valoración", descripcion: "Bloque 3: Suficiencia del material.", titulo: "Necesité buscar información por fuera del material para poder resolverlo.", tipo: "escala", opciones: escalaValoracion },
  ...
  { id: "c28", seccion: "Sección 3 - Escala de valoración", descripcion: "Bloque 4: Verificación de la comprensión.", titulo: "Mientras trabajaba con el material, pude darme cuenta por mí mismo si lo estaba entendiendo.", tipo: "escala", opciones: escalaValoracion },
  ...
  { id: "c30", seccion: "Sección 3 - Escala de valoración", descripcion: "Bloque 4: Verificación de la comprensión.", titulo: "Me di cuenta de que no había entendido bien recién cuando tuve que usar el contenido.", tipo: "escala", opciones: escalaValoracion },
  { id: "c31", seccion: "Sección 3 - Escala de valoración", descripcion: "Bloque 4: Verificación de la comprensión.", titulo: "Al terminar, tenía claro qué partes del contenido no me habían quedado del todo.", tipo: "escala", opciones: escalaValoracion },
  ...
  { id: "c37", seccion: "Sección 3 - Escala de valoración", descripcion: "Bloque 5: Esfuerzo requerido.", titulo: "Me costó más entender cómo estaba organizado el material que el tema en sí.", tipo: "escala", opciones: escalaValoracion },
  { id: "c38", seccion: "Sección 3 - Escala de valoración", descripcion: "Bloque 5: Esfuerzo requerido.", titulo: "Trabajar con ese material mejoró efectivamente mi comprensión.", tipo: "escala", opciones: escalaValoracion },
